import { EntityComponentTypes, EquipmentSlot, ItemLockMode, ItemStack, system } from "@minecraft/server";
...
const escape = {
    ...
    activate(player) {
        const markLoc = player.getDynamicProperty(this.define_var.markedProperty);
        if (markLoc) {
